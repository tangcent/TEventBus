...
public class ReflectionUtils {
     ...
     * Always has SpringProxy.class at last of proxyInterfaces.
     *
     * @param proxy the proxy to analyze
     * @return all user-specified interfaces that the proxy implements,
     * in the original order (never {@code null} or empty)
     * @see Advised
     * @see org.springframework.aop.framework.AopProxyUtils#proxiedUserInterfaces
     */
    public static Class<?>[] proxiedUserInterfaces(Object proxy) {
        ...
        Class<?>[] userInterfaces = new Class<?>[proxyInterfaces.length - nonUserIfcCount + 1];
        System.arraycopy(proxyInterfaces, 0, userInterfaces, 0, userInterfaces.length - 1);
        userInterfaces[userInterfaces.length - 1] = SpringProxy.class;
