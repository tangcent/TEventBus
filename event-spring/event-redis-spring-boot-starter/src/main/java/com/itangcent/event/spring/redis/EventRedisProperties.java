...
@ConfigurationProperties(prefix = "tevent.redis")
public class EventRedisProperties {

    /**
     * use 'spring.redis' instead of 'tevent.redis'
     */
    private boolean prefixWithSpring = true;

    private int eventThread = -1;
    ...
    public boolean isPrefixWithSpring() {
        return prefixWithSpring;
    }

    public void setPrefixWithSpring(boolean prefixWithSpring) {
        this.prefixWithSpring = prefixWithSpring;
    }
