...
public abstract class Invokable<T, R> extends Element implements GenericDeclaration {
    ...
    public final R invoke(T receiver, Object... args)
        ...
        return (R) invokeInternal(receiver, Objects.requireNonNull(args));
    }
    ...
    public final List<Parameter> getParameters() {
        ...
        List<Parameter> parameters = Collections.newArrayList();
    ...
    public final List<TypeToken<? extends Throwable>> getExceptionTypes() {
        List<TypeToken<? extends Throwable>> tokens = Collections.newArrayList();
